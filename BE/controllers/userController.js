...
exports.login = (req, res) => {
  ...
  // CHỈ THAY ĐỔI: thêm BINARY để so sánh email đúng hoa/thường
...
exports.register = async (req, res) => {
  ...
  try {
    // CHỈ THAY ĐỔI: thêm BINARY để kiểm tra email trùng đúng hoa/thường
...
exports.updateProfile = (req, res) => {
  ...
  // CHỈ THAY ĐỔI: thêm BINARY để kiểm tra email trùng đúng hoa/thường
  const checkEmailSql = "SELECT id FROM users WHERE BINARY email = ? AND id != ?";
